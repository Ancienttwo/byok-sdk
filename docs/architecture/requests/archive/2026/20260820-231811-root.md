...
- Status: No architecture change
- Archived: 2026-08-20T23:18:12+0800
- Artifacts: (none)
- Note: policy.json capability_source single-authority declaration from managed repo-harness init refresh (aa76753); no product module boundary, entrypoint, dependency rule, or runtime path affected
