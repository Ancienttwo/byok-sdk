...
- Status: No architecture change
- Archived: 2026-08-21T21:04:58+0800
- Artifacts:
- `.ai/harness/policy.json`
- Note: Circuit-breaker limits change repo workflow policy only; they do not alter product modules, entrypoints, dependencies, runtime paths, or verification command ownership.
