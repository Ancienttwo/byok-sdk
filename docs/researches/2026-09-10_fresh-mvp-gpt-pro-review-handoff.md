...
3. Salesko `docs/researches/2026-09-09_private-agent-chat-host-reliability-s0-parameter-draft.md`：重点 §8–§13；内容/安全模板、双模型预算、存储归属与 weekly 计量候选。
...
- Salesko 文档提交：`4b684644652564f75796b7b6e819fcae6edaba0c`，同名文档分支，基于 `6900ed6`。入口：[canonical Sprint](https://github.com/Ancienttwo/salesko-new/blob/4b684644652564f75796b7b6e819fcae6edaba0c/plans/plan-20260909-private-agent-chat-host-reliability-sprints.md)、[S0 草表](https://github.com/Ancienttwo/salesko-new/blob/4b684644652564f75796b7b6e819fcae6edaba0c/docs/researches/2026-09-09_private-agent-chat-host-reliability-s0-parameter-draft.md)。
