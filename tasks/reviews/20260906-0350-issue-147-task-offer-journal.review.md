...
- Parent review: on target. No new dependency, fallback, wire/schema migration, version bump or unrelated production edit. The journal opensTask predicate consumes protocol authority. Subsequent integration review found a separate pre-existing observer.ts offer predicate; that observation path remains out of scope.
