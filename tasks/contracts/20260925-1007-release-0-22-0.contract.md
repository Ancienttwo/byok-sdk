...
```json
{
  ...
  "checks": [
    ...
    },
    {
      ...
      "command": "bun run check:release-pack --out-dir /private/tmp/h5-salesko-prep-20260923/release-022-artifacts"
    },
    {
      "id": "publish-dry-run",
      "kind": "command",
      ...
      "cost": "normal",
      "evidence_policy": "current_exact",
      "necessity": "Owner-required registry-candidacy and source-bound nine-package publication plan; no --execute and no tag.",
      "inputs": {
        "env": [
          "TMPDIR"
        ]
      },
      "command": "node scripts/release/publish.mjs --artifacts /private/tmp/h5-salesko-prep-20260923/release-022-artifacts"
    }
  ]
}
```
