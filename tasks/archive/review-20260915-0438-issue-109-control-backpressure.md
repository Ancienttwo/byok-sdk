...
> **Contract**: tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md
...
- P1/P2/P3 evidence: plan `plans/archive/plan-20260901-0409-issue-109-control-backpressure.md` records the connection owner map, precise response/event-to-socket trace, and one-writer decision.
...
- Implementation notes reviewed: `tasks/archive/notes-20260915-0438-issue-109-control-backpressure.md`.
