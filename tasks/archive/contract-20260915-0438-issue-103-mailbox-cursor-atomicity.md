...
> **Archive Projection V1**: `plans/plan-20260831-2304-issue-103-mailbox-cursor-atomicity.md` => `plans/archive/plan-20260831-2304-issue-103-mailbox-cursor-atomicity.md`
> **Archive Projection V1**: `tasks/notes/20260831-2304-issue-103-mailbox-cursor-atomicity.notes.md` => `tasks/archive/notes-20260915-0438-issue-103-mailbox-cursor-atomicity.md`
> **Archive Projection V1**: `tasks/contracts/20260831-2304-issue-103-mailbox-cursor-atomicity.contract.md` => `tasks/archive/contract-20260915-0438-issue-103-mailbox-cursor-atomicity.md`
> **Archive Projection V1**: `tasks/reviews/20260831-2304-issue-103-mailbox-cursor-atomicity.review.md` => `tasks/archive/review-20260915-0438-issue-103-mailbox-cursor-atomicity.md`

# Task Contract: issue-103-mailbox-cursor-atomicity

> **Status**: Fulfilled
> **Plan**: plans/archive/plan-20260831-2304-issue-103-mailbox-cursor-atomicity.md
> **Task Profile**: bugfix
...
> **Review File**: `tasks/archive/review-20260915-0438-issue-103-mailbox-cursor-atomicity.md`
> **Notes File**: `tasks/archive/notes-20260915-0438-issue-103-mailbox-cursor-atomicity.md`
...
- Source plan: `plans/archive/plan-20260831-2304-issue-103-mailbox-cursor-atomicity.md`
...
```yaml
allowed_paths:
  - plans/archive/plan-20260831-2304-issue-103-mailbox-cursor-atomicity.md
  - tasks/todos.md
  - tasks/archive/contract-20260915-0438-issue-103-mailbox-cursor-atomicity.md
  - tasks/archive/review-20260915-0438-issue-103-mailbox-cursor-atomicity.md
  - tasks/archive/notes-20260915-0438-issue-103-mailbox-cursor-atomicity.md
