...
> **Status**: Fulfilled
> **Plan**: plans/archive/plan-20260901-0409-issue-109-control-backpressure.md
> **Task Profile**: bugfix
...
> **Notes File**: `tasks/archive/notes-20260915-0438-issue-109-control-backpressure.md`
...
- Source plan: `plans/archive/plan-20260901-0409-issue-109-control-backpressure.md`
...
```yaml
allowed_paths:
  - plans/archive/plan-20260901-0409-issue-109-control-backpressure.md
  - tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md
  - tasks/archive/review-20260915-0438-issue-109-control-backpressure.md
  - tasks/archive/notes-20260915-0438-issue-109-control-backpressure.md
