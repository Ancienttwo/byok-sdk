...
> **Status**: Fulfilled
> **Plan**: plans/archive/plan-20260826-1405-agent-provider-profile-binding.md
...
> **Notes File**: `tasks/archive/notes-20260915-0438-agent-provider-profile-binding.md`
...
- Source plan: `plans/archive/plan-20260826-1405-agent-provider-profile-binding.md`
...
```yaml
allowed_paths:
  - plans/archive/plan-20260826-1405-agent-provider-profile-binding.md
  - tasks/todos.md
  - tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md
  - tasks/archive/review-20260915-0438-agent-provider-profile-binding.md
  - tasks/archive/notes-20260915-0438-agent-provider-profile-binding.md
