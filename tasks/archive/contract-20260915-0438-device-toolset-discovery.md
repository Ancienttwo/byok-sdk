...
> **Notes File**: `tasks/archive/notes-20260915-0438-device-toolset-discovery.md`
...
- Source plan: `plans/archive/plan-20260813-2350-device-toolset-discovery.md`
...
allowed_paths:
  ...
  - plans/
  - tasks/todos.md
  - tasks/archive/contract-20260915-0438-device-toolset-discovery.md
  - tasks/archive/review-20260915-0438-device-toolset-discovery.md
  - tasks/archive/notes-20260915-0438-device-toolset-discovery.md
  - .ai/harness/
```
