...
```json
{"protocol":1,"oracles":[{"id":"approval-projection-required-checks","kind":"deterministic_test","paths":["*"]},{"id":"approval-host-runtime-readback","kind":"runtime_readback","paths":["examples/live-activity-host/src/*"]}]}
```
