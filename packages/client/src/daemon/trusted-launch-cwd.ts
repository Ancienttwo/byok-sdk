...
export type TrustedLaunchCwdUnavailableReason =
  ...
  | 'root_cannot_prove_write_boundary'
  | 'configured_dir_not_absolute'
  | 'configured_dir_unreadable'
  | 'configured_dir_is_a_symlink'
  | 'configured_dir_not_a_directory'
  | 'configured_dir_is_writable'
  | 'no_platform_default_directory'
  | 'platform_default_not_absolute'
  | 'platform_default_unreadable'
  | 'platform_default_is_a_symlink'
  | 'platform_default_not_a_directory'
