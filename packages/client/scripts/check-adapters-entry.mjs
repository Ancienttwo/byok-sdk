...
// stay upstream, the resolved manifest is @byok-sdk/pi-coding-agent@0.85.1002.
assert.equal(manifest.dependencies?.['@earendil-works/pi-coding-agent'], 'npm:@byok-sdk/pi-coding-agent@0.85.1002');
