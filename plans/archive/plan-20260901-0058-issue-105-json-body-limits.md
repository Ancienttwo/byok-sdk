...
> **Spec**: `docs/spec.md`
> **Task Contract**: `tasks/archive/contract-20260915-0438-issue-105-json-body-limits.md`
> **Task Review**: `tasks/archive/review-20260915-0438-issue-105-json-body-limits.md`
> **Implementation Notes**: `tasks/archive/notes-20260915-0438-issue-105-json-body-limits.md`
...
- Active plan: `plans/archive/plan-20260901-0058-issue-105-json-body-limits.md`
...
- Notes: `tasks/archive/notes-20260915-0438-issue-105-json-body-limits.md`
...
- **State/progress path**: `tasks/current.md`, this plan's `## Task Breakdown`, and `tasks/archive/notes-20260915-0438-issue-105-json-body-limits.md`.
