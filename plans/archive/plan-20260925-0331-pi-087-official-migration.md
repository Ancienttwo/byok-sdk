...
> **Task Contract**: `tasks/archive/contract-20260925-1339-pi-087-official-migration.md`
> **Task Review**: `tasks/archive/review-20260925-1339-pi-087-official-migration.md`
> **Implementation Notes**: `tasks/archive/notes-20260925-1339-pi-087-official-migration.md`
...
- Active plan: `plans/archive/plan-20260925-0331-pi-087-official-migration.md`
- Sprint contract: `tasks/archive/contract-20260925-1339-pi-087-official-migration.md`
- Sprint review: `tasks/archive/review-20260925-1339-pi-087-official-migration.md`
- Implementation notes: `tasks/archive/notes-20260925-1339-pi-087-official-migration.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260925-1339-pi-087-official-migration.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/archive/plan-20260925-0331-pi-087-official-migration.md` and may start `repo-harness run contract-worktree start --plan plans/archive/plan-20260925-0331-pi-087-official-migration.md`.
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260925-1339-pi-087-official-migration.md`
- Review file: `tasks/archive/review-20260925-1339-pi-087-official-migration.md`
- Implementation notes file: `tasks/archive/notes-20260925-1339-pi-087-official-migration.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260925-1339-pi-087-official-migration.md --strict`
...
- **Merge/PR unit**: Captured plan `plans/archive/plan-20260925-0331-pi-087-official-migration.md` is the proposed mergeable execution unit; revise before execute if this is only a checklist step.
- **Rollback surface**: revert branch claude/pi-087-migration; fork packages remain published
- **Verification boundary**: bun run build; typecheck; test; check:api-surface; check:version-authority; check:release-pack; repo-harness run check-task-workflow --strict; conformance suite; gatekeeper per WP + composite
- **Review/acceptance boundary**: `tasks/archive/review-20260925-1339-pi-087-official-migration.md` must record pass against the captured acceptance criteria.
- **High-risk surface**: Risks named in captured planning output; keep the plan Draft if risk ownership is not concrete.
- **Why not checklist row**: human_decision_boundary

## Evidence Contract

- **State/progress path**: `plans/archive/plan-20260925-0331-pi-087-official-migration.md` task breakdown, `tasks/todos.md` deferred-goal ledger, `tasks/archive/contract-20260925-1339-pi-087-official-migration.md`, `tasks/archive/review-20260925-1339-pi-087-official-migration.md`, and `tasks/archive/notes-20260925-1339-pi-087-official-migration.md`
- **Verification evidence**: `.ai/harness/checks/latest.json`, `.ai/harness/runs/`, and the commands named in the captured planning output
- **Evaluator rubric**: `tasks/archive/review-20260925-1339-pi-087-official-migration.md` must record a passing Waza /check style recommendation
...
- **Amendment 1 (2026-09-25, orchestrator, after WP1)** — A1' compile target. WP1 found pi-ai resolves `compat` from `provider`/`baseUrl` substring detection and overrides only field-by-field with explicit `model.compat` (`detectCompat`/`getCompat`, not exported; the wire carries 7 of 27 keys). A sink-URL compile therefore cannot reproduce live bytes for a real endpoint. A1' now compiles D with the same projected model object the runtime registers (real `baseUrl`, real provider id), injected capture-and-throw `fetch`, placeholder key, `maxRetries: 0`, pinned `cacheRetention`, fixed `sessionId`. The no-leak guarantee moves from the sink URL to exact version pin + conformance (d') proving the injected `fetch` is the sole transport path and (g) documenting the sink-vs-real divergence. U1 (`buildRequestPayload`) removes the transport entirely; its upstream PR is therefore the priority follow-up. Owner informed in-session; reversible.
