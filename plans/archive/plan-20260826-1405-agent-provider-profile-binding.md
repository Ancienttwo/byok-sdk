...
> **Related Plan**: plans/archive/plan-20260826-1405-agent-provider-profile-binding.md
> **Outcome**: Completed
> **Lifecycle**: plan
> **Parent Run ID**: run-20260915-0438
> **Archive Projection V1**: `plans/plan-20260826-1405-agent-provider-profile-binding.md` => `plans/archive/plan-20260826-1405-agent-provider-profile-binding.md`
> **Archive Projection V1**: `tasks/notes/20260826-1405-agent-provider-profile-binding.notes.md` => `tasks/archive/notes-20260915-0438-agent-provider-profile-binding.md`
> **Archive Projection V1**: `tasks/contracts/20260826-1405-agent-provider-profile-binding.contract.md` => `tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md`
> **Archive Projection V1**: `tasks/reviews/20260826-1405-agent-provider-profile-binding.review.md` => `tasks/archive/review-20260915-0438-agent-provider-profile-binding.md`
...
> **Task Contract**: `tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md`
> **Task Review**: `tasks/archive/review-20260915-0438-agent-provider-profile-binding.md`
> **Implementation Notes**: `tasks/archive/notes-20260915-0438-agent-provider-profile-binding.md`
...
- Active plan: `plans/archive/plan-20260826-1405-agent-provider-profile-binding.md`
- Sprint contract: `tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md`
- Sprint review: `tasks/archive/review-20260915-0438-agent-provider-profile-binding.md`
- Implementation notes: `tasks/archive/notes-20260915-0438-agent-provider-profile-binding.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/archive/plan-20260826-1405-agent-provider-profile-binding.md` and may start `repo-harness run contract-worktree start --plan plans/archive/plan-20260826-1405-agent-provider-profile-binding.md`.
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md`
- Review file: `tasks/archive/review-20260915-0438-agent-provider-profile-binding.md`
- Implementation notes file: `tasks/archive/notes-20260915-0438-agent-provider-profile-binding.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md --strict`
...
- **Merge/PR unit**: Captured plan `plans/archive/plan-20260826-1405-agent-provider-profile-binding.md` is the proposed mergeable execution unit; revise before execute if this is only a checklist step.
- **Rollback surface**: The additive provider-profile binding capability, status projection, dispatch selection fields, keys registry schema, Pi launcher projection, and associated docs/tests.
- **Verification boundary**: Protocol and keys unit tests, client runtime admission tests, packed tarball smoke, and frozen Salesko consumer falsifier.
- **Review/acceptance boundary**: `tasks/archive/review-20260915-0438-agent-provider-profile-binding.md` must record pass against the captured acceptance criteria.
...
- **State/progress path**: `plans/archive/plan-20260826-1405-agent-provider-profile-binding.md` task breakdown, `tasks/todos.md` deferred-goal ledger, `tasks/archive/contract-20260915-0438-agent-provider-profile-binding.md`, `tasks/archive/review-20260915-0438-agent-provider-profile-binding.md`, and `tasks/archive/notes-20260915-0438-agent-provider-profile-binding.md`
- **Verification evidence**: `.ai/harness/checks/latest.json`, `.ai/harness/runs/`, and the commands named in the captured planning output
- **Evaluator rubric**: `tasks/archive/review-20260915-0438-agent-provider-profile-binding.md` must record a passing Waza /check style recommendation
