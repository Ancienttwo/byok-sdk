...
> **Related Plan**: plans/archive/plan-20260821-2336-local-agent-version-tolerance.md
> **Outcome**: Completed
> **Lifecycle**: plan
> **Parent Run ID**: run-20260915-0438
> **Archive Projection V1**: `plans/plan-20260821-2336-local-agent-version-tolerance.md` => `plans/archive/plan-20260821-2336-local-agent-version-tolerance.md`
> **Archive Projection V1**: `tasks/notes/20260821-2336-local-agent-version-tolerance.notes.md` => `tasks/archive/notes-20260915-0438-local-agent-version-tolerance.md`
> **Archive Projection V1**: `tasks/contracts/20260821-2336-local-agent-version-tolerance.contract.md` => `tasks/archive/contract-20260915-0438-local-agent-version-tolerance.md`
> **Archive Projection V1**: `tasks/reviews/20260821-2336-local-agent-version-tolerance.review.md` => `tasks/archive/review-20260915-0438-local-agent-version-tolerance.md`
...
> **Task Contract**: `tasks/archive/contract-20260915-0438-local-agent-version-tolerance.md`
> **Task Review**: `tasks/archive/review-20260915-0438-local-agent-version-tolerance.md`
> **Implementation Notes**: `tasks/archive/notes-20260915-0438-local-agent-version-tolerance.md`
...
- Active plan: `plans/archive/plan-20260821-2336-local-agent-version-tolerance.md`
- Sprint contract: `tasks/archive/contract-20260915-0438-local-agent-version-tolerance.md`
- Sprint review: `tasks/archive/review-20260915-0438-local-agent-version-tolerance.md`
- Implementation notes: `tasks/archive/notes-20260915-0438-local-agent-version-tolerance.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260915-0438-local-agent-version-tolerance.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/archive/plan-20260821-2336-local-agent-version-tolerance.md` and may start `repo-harness run contract-worktree start --plan plans/archive/plan-20260821-2336-local-agent-version-tolerance.md`.
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260915-0438-local-agent-version-tolerance.md`
- Review file: `tasks/archive/review-20260915-0438-local-agent-version-tolerance.md`
- Implementation notes file: `tasks/archive/notes-20260915-0438-local-agent-version-tolerance.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260915-0438-local-agent-version-tolerance.md --strict`
...
- **Merge/PR unit**: Captured plan `plans/archive/plan-20260821-2336-local-agent-version-tolerance.md` is the proposed mergeable execution unit; revise before execute if this is only a checklist step.
- **Rollback surface**: Revert the additive MachineInfo release projection, forwarding, tests, and spec text together.
- **Verification boundary**: Focused self-hosted compatibility matrix, server package checks, strict workflow, and architecture sync.
- **Review/acceptance boundary**: `tasks/archive/review-20260915-0438-local-agent-version-tolerance.md` must record pass against the captured acceptance criteria.
- **High-risk surface**: Risks named in captured planning output; keep the plan Draft if risk ownership is not concrete.
- **Why not checklist row**: public_read_model_closure

## Evidence Contract

- **State/progress path**: `plans/archive/plan-20260821-2336-local-agent-version-tolerance.md` task breakdown, `tasks/todos.md` deferred-goal ledger, `tasks/archive/contract-20260915-0438-local-agent-version-tolerance.md`, `tasks/archive/review-20260915-0438-local-agent-version-tolerance.md`, and `tasks/archive/notes-20260915-0438-local-agent-version-tolerance.md`
- **Verification evidence**: `.ai/harness/checks/latest.json`, `.ai/harness/runs/`, and the commands named in the captured planning output
- **Evaluator rubric**: `tasks/archive/review-20260915-0438-local-agent-version-tolerance.md` must record a passing Waza /check style recommendation
