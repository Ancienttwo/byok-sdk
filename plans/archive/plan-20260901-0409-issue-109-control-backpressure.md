...
> **Related Plan**: plans/archive/plan-20260901-0409-issue-109-control-backpressure.md
> **Outcome**: Completed
> **Lifecycle**: plan
> **Parent Run ID**: run-20260915-0438
> **Archive Projection V1**: `plans/plan-20260901-0409-issue-109-control-backpressure.md` => `plans/archive/plan-20260901-0409-issue-109-control-backpressure.md`
> **Archive Projection V1**: `tasks/notes/20260901-0409-issue-109-control-backpressure.notes.md` => `tasks/archive/notes-20260915-0438-issue-109-control-backpressure.md`
> **Archive Projection V1**: `tasks/contracts/20260901-0409-issue-109-control-backpressure.contract.md` => `tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md`
> **Archive Projection V1**: `tasks/reviews/20260901-0409-issue-109-control-backpressure.review.md` => `tasks/archive/review-20260915-0438-issue-109-control-backpressure.md`
...
> **Task Contract**: `tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md`
> **Task Review**: `tasks/archive/review-20260915-0438-issue-109-control-backpressure.md`
> **Implementation Notes**: `tasks/archive/notes-20260915-0438-issue-109-control-backpressure.md`
...
- Active plan: `plans/archive/plan-20260901-0409-issue-109-control-backpressure.md`
- Sprint contract: `tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md`
- Sprint review: `tasks/archive/review-20260915-0438-issue-109-control-backpressure.md`
- Implementation notes: `tasks/archive/notes-20260915-0438-issue-109-control-backpressure.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/archive/plan-20260901-0409-issue-109-control-backpressure.md` and may start `repo-harness run contract-worktree start --plan plans/archive/plan-20260901-0409-issue-109-control-backpressure.md`.
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md`
- Review file: `tasks/archive/review-20260915-0438-issue-109-control-backpressure.md`
- Implementation notes file: `tasks/archive/notes-20260915-0438-issue-109-control-backpressure.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260915-0438-issue-109-control-backpressure.md --strict`
