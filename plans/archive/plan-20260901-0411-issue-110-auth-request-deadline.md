...
> **Related Plan**: plans/archive/plan-20260901-0411-issue-110-auth-request-deadline.md
> **Outcome**: Completed
> **Lifecycle**: plan
> **Parent Run ID**: run-20260915-0438
> **Archive Projection V1**: `plans/plan-20260901-0411-issue-110-auth-request-deadline.md` => `plans/archive/plan-20260901-0411-issue-110-auth-request-deadline.md`
> **Archive Projection V1**: `tasks/notes/20260901-0411-issue-110-auth-request-deadline.notes.md` => `tasks/archive/notes-20260915-0438-issue-110-auth-request-deadline.md`
> **Archive Projection V1**: `tasks/contracts/20260901-0411-issue-110-auth-request-deadline.contract.md` => `tasks/archive/contract-20260915-0438-issue-110-auth-request-deadline.md`
> **Archive Projection V1**: `tasks/reviews/20260901-0411-issue-110-auth-request-deadline.review.md` => `tasks/archive/review-20260915-0438-issue-110-auth-request-deadline.md`
...
> **Task Contract**: `tasks/archive/contract-20260915-0438-issue-110-auth-request-deadline.md`
> **Task Review**: `tasks/archive/review-20260915-0438-issue-110-auth-request-deadline.md`
> **Implementation Notes**: `tasks/archive/notes-20260915-0438-issue-110-auth-request-deadline.md`
...
- Active plan: `plans/archive/plan-20260901-0411-issue-110-auth-request-deadline.md`
- Sprint contract: `tasks/archive/contract-20260915-0438-issue-110-auth-request-deadline.md`
- Sprint review: `tasks/archive/review-20260915-0438-issue-110-auth-request-deadline.md`
- Implementation notes: `tasks/archive/notes-20260915-0438-issue-110-auth-request-deadline.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260915-0438-issue-110-auth-request-deadline.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/archive/plan-20260901-0411-issue-110-auth-request-deadline.md` and may start `repo-harness run contract-worktree start --plan plans/archive/plan-20260901-0411-issue-110-auth-request-deadline.md`.
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260915-0438-issue-110-auth-request-deadline.md`
- Review file: `tasks/archive/review-20260915-0438-issue-110-auth-request-deadline.md`
- Implementation notes file: `tasks/archive/notes-20260915-0438-issue-110-auth-request-deadline.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260915-0438-issue-110-auth-request-deadline.md --strict`
...
- **Merge/PR unit**: Captured plan `plans/archive/plan-20260901-0411-issue-110-auth-request-deadline.md` is the proposed mergeable execution unit; revise before execute if this is only a checklist step.
- **Rollback surface**: Revert the AuthManager request deadline/controller, daemon config composition, config coverage, test fixture hooks, and auth/daemon regressions together.
- **Verification boundary**: Deterministic pair/challenge/token/body hangs, stop abort, persistence/revocation assertions, client/root gates, strict workflow, and diff check.
- **Review/acceptance boundary**: `tasks/archive/review-20260915-0438-issue-110-auth-request-deadline.md` must record pass against the captured acceptance criteria.
...
- **State/progress path**: `plans/archive/plan-20260901-0411-issue-110-auth-request-deadline.md` task breakdown, `tasks/todos.md` deferred-goal ledger, `tasks/archive/contract-20260915-0438-issue-110-auth-request-deadline.md`, `tasks/archive/review-20260915-0438-issue-110-auth-request-deadline.md`, and `tasks/archive/notes-20260915-0438-issue-110-auth-request-deadline.md`
- **Verification evidence**: `.ai/harness/checks/latest.json`, `.ai/harness/runs/`, and the commands named in the captured planning output
- **Evaluator rubric**: `tasks/archive/review-20260915-0438-issue-110-auth-request-deadline.md` must record a passing Waza /check style recommendation
