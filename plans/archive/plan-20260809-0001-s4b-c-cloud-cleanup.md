...
> **Archive Projection V1**: `plans/plan-20260809-0001-s4b-c-cloud-cleanup.md` => `plans/archive/plan-20260809-0001-s4b-c-cloud-cleanup.md`
> **Archive Projection V1**: `tasks/notes/20260809-0001-s4b-c-cloud-cleanup.notes.md` => `tasks/archive/notes-20260915-0438-s4b-c-cloud-cleanup.md`
> **Archive Projection V1**: `tasks/contracts/20260809-0001-s4b-c-cloud-cleanup.contract.md` => `tasks/archive/contract-20260915-0438-s4b-c-cloud-cleanup.md`
> **Archive Projection V1**: `tasks/reviews/20260809-0001-s4b-c-cloud-cleanup.review.md` => `tasks/archive/review-20260915-0438-s4b-c-cloud-cleanup.md`
...
> **Task Contract**: `tasks/archive/contract-20260915-0438-s4b-c-cloud-cleanup.md`
> **Task Review**: `tasks/archive/review-20260915-0438-s4b-c-cloud-cleanup.md`
> **Implementation Notes**: `tasks/archive/notes-20260915-0438-s4b-c-cloud-cleanup.md`
...
- Active plan: `plans/archive/plan-20260809-0001-s4b-c-cloud-cleanup.md`
- Sprint contract: `tasks/archive/contract-20260915-0438-s4b-c-cloud-cleanup.md`
- Sprint review: `tasks/archive/review-20260915-0438-s4b-c-cloud-cleanup.md`
- Implementation notes: `tasks/archive/notes-20260915-0438-s4b-c-cloud-cleanup.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260915-0438-s4b-c-cloud-cleanup.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/archive/plan-20260809-0001-s4b-c-cloud-cleanup.md` and may start `repo-harness run contract-worktree start --plan plans/archive/plan-20260809-0001-s4b-c-cloud-cleanup.md`.
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260915-0438-s4b-c-cloud-cleanup.md`
- Review file: `tasks/archive/review-20260915-0438-s4b-c-cloud-cleanup.md`
- Implementation notes file: `tasks/archive/notes-20260915-0438-s4b-c-cloud-cleanup.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260915-0438-s4b-c-cloud-cleanup.md --strict`
