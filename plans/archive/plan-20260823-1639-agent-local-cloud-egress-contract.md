...
> **Related Plan**: plans/archive/plan-20260823-1639-agent-local-cloud-egress-contract.md
> **Outcome**: Completed
> **Lifecycle**: plan
> **Parent Run ID**: run-20260915-0438
> **Archive Projection V1**: `plans/plan-20260823-1639-agent-local-cloud-egress-contract.md` => `plans/archive/plan-20260823-1639-agent-local-cloud-egress-contract.md`
> **Archive Projection V1**: `tasks/notes/20260823-1639-agent-local-cloud-egress-contract.notes.md` => `tasks/archive/notes-20260915-0438-agent-local-cloud-egress-contract.md`
> **Archive Projection V1**: `tasks/contracts/20260823-1639-agent-local-cloud-egress-contract.contract.md` => `tasks/archive/contract-20260915-0438-agent-local-cloud-egress-contract.md`
> **Archive Projection V1**: `tasks/reviews/20260823-1639-agent-local-cloud-egress-contract.review.md` => `tasks/archive/review-20260915-0438-agent-local-cloud-egress-contract.md`
...
> **Task Contract**: `tasks/archive/contract-20260915-0438-agent-local-cloud-egress-contract.md`
> **Task Review**: `tasks/archive/review-20260915-0438-agent-local-cloud-egress-contract.md`
> **Implementation Notes**: `tasks/archive/notes-20260915-0438-agent-local-cloud-egress-contract.md`
...
- Active plan: `plans/archive/plan-20260823-1639-agent-local-cloud-egress-contract.md`
- Sprint contract: `tasks/archive/contract-20260915-0438-agent-local-cloud-egress-contract.md`
- Sprint review: `tasks/archive/review-20260915-0438-agent-local-cloud-egress-contract.md`
- Implementation notes: `tasks/archive/notes-20260915-0438-agent-local-cloud-egress-contract.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260915-0438-agent-local-cloud-egress-contract.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/archive/plan-20260823-1639-agent-local-cloud-egress-contract.md` and may start `repo-harness run contract-worktree start --plan plans/archive/plan-20260823-1639-agent-local-cloud-egress-contract.md`.
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260915-0438-agent-local-cloud-egress-contract.md`
- Review file: `tasks/archive/review-20260915-0438-agent-local-cloud-egress-contract.md`
- Implementation notes file: `tasks/archive/notes-20260915-0438-agent-local-cloud-egress-contract.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260915-0438-agent-local-cloud-egress-contract.md --strict`
