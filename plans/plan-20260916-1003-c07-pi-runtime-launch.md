...
- [ ] P3d **ACTIVE — usage-only21ab3c86; extension runner design held for P4 multi-kind record, handoff§96** Close SDK-owned jiti/rpiv-i18n startup discovery and remaining S2 MCP launcher asset, team relay and daemon construction package discovery, separately from Pi Tier1. Actual lane/process reachability recorded in handoff §93; requires release-bound asset/runtime path, no package fallback. Not implemented by P3c.
