...
- [ ] P3c **implemented 00c5529a; gate 8b016495 FAIL on helper usage; r1 product 87d9b5f9 frozen, full/re-gate pending**: implement approved full-config argv checksum and strict child runtime binding, ordered self/asset/native provenance checks, then execute real two-lane containment and negatives. Exact contract in handoff §93; no Host reader or 1006 fork changes.
