...
- [ ] P3c implement approved full-config argv checksum and strict child runtime binding, ordered self/asset/native provenance checks, then execute real two-lane containment and negatives. Exact contract in handoff §93; no Host reader or 1006 fork changes.
