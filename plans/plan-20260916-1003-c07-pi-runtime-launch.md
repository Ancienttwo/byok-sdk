...
- [ ] P3a Test-only real S2 startup guard: adapter-resolved launch bindings and actual ordinary/prepared hosts, preserved containment/cache assertions, hermetic no-install execution. Record product-unchanged RED separately from native1005 closure blockers before product edits.
