...
- [ ] P3b Static SDK manifest pin + lazy mutually exclusive dev resolution + unused extension resolver/option retirement. Preserve prepared independent-expectation gap; no caller-authored replacement. Authority table in handoff §93.
