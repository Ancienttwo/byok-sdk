...
> **Verification Boundary**: Commands named in the captured planning output plus `repo-harness run verify-contract --contract tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md --strict`.
> **Rollback Surface**: Before execution remove `plans/plan-20260816-1550-live-activity-timeline-pr1-tool-correlation.md`; after execution revert branch `codex/live-activity-timeline-pr1-tool-correlation` or the explicitly reviewed diff.
> **Spec**: `docs/spec.md`
> **Research**: See `docs/researches/`
> **Task Contract**: `tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md`
> **Task Review**: `tasks/reviews/20260816-1550-live-activity-timeline-pr1-tool-correlation.review.md`
> **Implementation Notes**: `tasks/notes/20260816-1550-live-activity-timeline-pr1-tool-correlation.notes.md`
...
- Active plan: `plans/plan-20260816-1550-live-activity-timeline-pr1-tool-correlation.md`
- Sprint contract: `tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md`
- Sprint review: `tasks/reviews/20260816-1550-live-activity-timeline-pr1-tool-correlation.review.md`
- Implementation notes: `tasks/notes/20260816-1550-live-activity-timeline-pr1-tool-correlation.notes.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md` `allowed_paths`
- Concurrency rule: `.ai/harness/active-plan` selects the active plan for this worktree when present; `.ai/harness/active-worktree` records the owning worktree. If another worktree already owns active work, open or switch to the matching worktree instead of serializing unrelated plans.
- Execution isolation: approved contract-level work projects through `repo-harness run plan-to-todo --plan plans/plan-20260816-1550-live-activity-timeline-pr1-tool-correlation.md` and may start `repo-harness run contract-worktree start --plan plans/plan-20260816-1550-live-activity-timeline-pr1-tool-correlation.md`.
...
## Task Contracts
- Contract file: `tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md`
- Review file: `tasks/reviews/20260816-1550-live-activity-timeline-pr1-tool-correlation.review.md`
- Implementation notes file: `tasks/notes/20260816-1550-live-activity-timeline-pr1-tool-correlation.notes.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md --strict`
...
- **Merge/PR unit**: Captured plan `plans/plan-20260816-1550-live-activity-timeline-pr1-tool-correlation.md` is the proposed mergeable execution unit; revise before execute if this is only a checklist step.
- **Rollback surface**: Before execution remove `plans/plan-20260816-1550-live-activity-timeline-pr1-tool-correlation.md`; after execution revert branch `codex/live-activity-timeline-pr1-tool-correlation` or the explicitly reviewed diff.
- **Verification boundary**: Commands named in the captured planning output plus `repo-harness run verify-contract --contract tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md --strict`.
- **Review/acceptance boundary**: `tasks/reviews/20260816-1550-live-activity-timeline-pr1-tool-correlation.review.md` must record pass against the captured acceptance criteria.
- **High-risk surface**: Risks named in captured planning output; keep the plan Draft if risk ownership is not concrete.
- **Why not checklist row**: human_decision_boundary

## Evidence Contract

- **State/progress path**: `plans/plan-20260816-1550-live-activity-timeline-pr1-tool-correlation.md` task breakdown, `tasks/todos.md` deferred-goal ledger, `tasks/contracts/20260816-1550-live-activity-timeline-pr1-tool-correlation.contract.md`, `tasks/reviews/20260816-1550-live-activity-timeline-pr1-tool-correlation.review.md`, and `tasks/notes/20260816-1550-live-activity-timeline-pr1-tool-correlation.notes.md`
- **Verification evidence**: `.ai/harness/checks/latest.json`, `.ai/harness/runs/`, and the commands named in the captured planning output
- **Evaluator rubric**: `tasks/reviews/20260816-1550-live-activity-timeline-pr1-tool-correlation.review.md` must record a passing Waza /check style recommendation
...
## Task Breakdown
- [x] Add the optional AgentEvent observation fields and regenerate the v1 frozen golden with additive-change coverage.
- [x] Map authoritative tool identity/outcome in Claude, Codex, and Pi; fail closed for malformed bundled native frames without heuristic fallback.
- [x] Add provider fixtures, including a pinned Pi 0.84.1 RPC JSONL probe, and cover same-name IDs plus outcome tri-state behavior.
- [x] Run targeted tests, build/typecheck/full test, strict workflow verification, and record implementation evidence.
- [x] Run Waza `$check` against the frozen final diff; resolve every blocking finding before acceptance.
