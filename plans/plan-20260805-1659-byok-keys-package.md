...
- [x] K4 Swap back into aip-main-open: `@byok-sdk/keys@0.1.0` registry publish/readback complete；consumer PR #7 passed unchanged settings golden and exact-head CI, then merged as `390307a50c0728a0fc243578b5b4b94ff4351360` on 2026-08-09。
- [x] K4.1 aip-side adapter (consequence of K3 dropping the settings-page server): aip keeps its own `settings.ts`; the thin adapter over `@byok-sdk/keys` supplies the three host-specific surfaces without adding them to the generic registry:
